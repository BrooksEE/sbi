...
#define _SBI_FORMAT_H
	...
	#define _istr_sub						0x11 // sub <any1> <any2> <var> ; var=any1-any2
	#define _istr_mul						0x12 // mul <any1> <any2> <var> ; var=any1*any2
	#define _istr_div						0x13 // div <any1> <any2> <var> ; var=any1/any2
    ...
    #define _istr_lte                       0x33 // lte <any1> <any2> <var> ; <var> = <any1> <= <any2>
    #define _istr_gte                       0x34 // gte <any1> <any2> <var> ; <var> = <any1> >= <any2>
	...
	#define _istr_cmpjump                   0x42 // cmpjump <any1> <any2> <any3> 1|0 ; if <any1> == <any2> then like jump <any3> 
    ...
    #define _istr_print                     0x53 // print "string" ; print a string constant
    #define _istr_printd                    0x54 // printd <any>   ; print an integer value
    ...
    #define _istr_alive                     0x72 // alive <var1> <var2> ; store 1 in <var2> if <var1> is a valid running thread id.
    #define _istr_stop                      0x73 // stop <var> ; causes thread with id in <var> to stop running.
